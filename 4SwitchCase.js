var tanggal = 7 // assign nilai variabel tanggal disini! (dengan angka antara 1 - 31)
	...
	if (tanggal > 0 && tanggal <=31){
		switch(bulan) {
			...
			case 9:   { console.log(tanggal + ' September ' + tahun); 
									if (tanggal > 30){
											console.log('Cakupan tanggal bulan September hanya sampai 30, mohon ubah kembali tanggal.');
									} break; }
			case 10:   { console.log(tanggal + ' Oktober ' + tahun); break; }
			case 11:   { console.log(tanggal + ' November ' + tahun);
										if (tanggal > 30){
												console.log('Cakupan tanggal bulan November hanya sampai 30, mohon ubah kembali tanggal.');
										} break; }
